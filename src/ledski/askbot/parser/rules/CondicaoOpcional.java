...
import static ledski.askbot.lexer.Token.TokenType._e;
import static ledski.askbot.lexer.Token.TokenType._ou;
...
/**
 * Regra:
 * CONDICAO_OPCIONAL -> OP_LOGICO  CONDICAO  CONDICAO_OPCIONAL | vazio
 * @author Leandro
 */
